...
def main():
    ...
    # Optional
    parser.add_argument('-a', '--auto_predict_f0', type=bool, default=False,
    ...
    parser.add_argument('-fmp', '--f0_mean_pooling', type=bool, default=False,
    ...
    parser.add_argument('-eh', '--enhance', type=bool, default=False,
